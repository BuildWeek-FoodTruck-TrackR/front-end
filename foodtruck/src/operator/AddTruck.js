...
const mapStateToProps = (state) => ({
  ...
  isSuccess: state.trucks.isSuccess
})
      ...
      <Card>
        <CardBody>
          <Form onSubmit={formSubmit} className="mb-3">
            ...
            <Button className="mt-4 btn-custom" color={buttonDisabled ? "secondary" : "primary"}>Add Truck</Button>
          </Form>
        </CardBody>
      </Card>
...
export default connect(mapStateToProps, { postData, activePage })(AddTruck);